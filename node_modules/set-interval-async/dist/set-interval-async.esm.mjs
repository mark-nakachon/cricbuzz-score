...
function _clearIntervalAsync() {
  _clearIntervalAsync = _asyncToGenerator(function* (timer) {
    ...
    var _arr = Object.values(timer.timeouts);
    ...
    let promises = Object.values(timer.promises).map(promise => {
      promise.catch(noop);
    });
...
export { dynamic, fixed, legacy, clearIntervalAsync, SetIntervalAsyncError, SetIntervalAsyncTimer };
